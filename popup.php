<div id="reveal-dialog" class="dialog-bg">
    <div class="dialog">
        ...
        <a id="download" class="dialog-download btn" download="" href=""><i class="fa fa-fw fa-download"></i>下载</a>
    </div>
</div>